...
<body>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-6 col-lg-4">
                    <div class="fm_work_content">
                        <img src="img/requirement1.png" alt="" class="img-responsive requirementimg" width="40">
                        <div class="fm_work_para">
                            <p>Share your Requirement</p>
                            <span class="fm_work_para_span">Tell us where and when do you want to move</span>
                        </div>
                    </div>
                    <div class="fm_work_content">
                        <img src="img/requirement3.png" alt="" class="img-responsive requirementimg" width="40">
                        <div class="fm_work_para">
                            <p>Schedule and Confirm</p>
                            <span class="fm_work_para_span">Pick a slot and pay a token amount to confirm your
                                move</span>
                        </div>
                    </div>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                    <div class="fm_work_content">
                        <img src="img/requirement2.png" alt="" class="img-responsive requirementimg" width="40">
                        <div class="fm_work_para">
                            <p>Get Free Instant Quote</p>
                            <span class="fm_work_para_span">Get guaranteed lowest priced quote for your shifting
                                instantly</span>
                        </div>
                    </div>
                    <div class="fm_work_content">
                        <img src="img/requirement4.png" alt="" class="img-responsive requirementimg" width="40">
                        <div class="fm_work_para">
                            <p>We get you moved!</p>
                            <span class="fm_work_para_span">Our partner will arive as per schedule to pack & load your
                                belonging</span>
                        </div>
                    </div>
                </div>
    ...
    <section>
        <div class="container-fluid fm_work">
            <h3>Why FastDeliver’s Packers and Movers ?</h3>
            <div class="row">
                <div class="col-sm-12 col-md-6 col-lg-4">
                    <div class="fm_work_content_best">
                        <div class="fm_work_para">
                            <img src="img/bestprice1.png" alt="" class="img-responsive bestpriceimg" width="40">
                            <p>Best Price</p>
                            <div class="para_u">
                                <span class="fm_work_para_span_u mb-3">100% price and service gurantee</span>
                            </div>
                            <span class="fm_work_para_span">No surprises on your shifting day, no hidden costs.
                                Saving on the shifting cost by upto 40%
                                Get exact prices based on shifting details
                                Save money - save time - <span id="more1">no damages</span></span>
                            <span onclick="myFunction1()" id="readmorebtn1">know more</span>
                        </div>
                    </div>
                    <div class="fm_work_content_best">
                        <div class="fm_work_para">
                            <img src="img/bestprice2.png" alt="" class="img-responsive bestpriceimg" width="40">
                            <p>5 Star Rated Partners</p>
                            <div class="para_u">
                                <span class="fm_work_para_span_u mb-3">Don't risk your precious Inventory with local
                                    vendors</span>
                            </div>
                            <span class="fm_work_para_span">Selected Top-rated shifting companies out of thousands
                                available in the market
                                No local vendors, only verified and best-in-class packers and movers are chosen
                                after<span id="more2">
                                    stringent quality checks
                                    No price changes on the day of your move, professional behaviour and obligation to
                                    the
                                    quoted price</span></span>
                            <span onclick="myFunction2()" id="readmorebtn2">know more</span>
                        </div>
                    </div>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4">
                    <div class="fm_work_content_best">
                        <div class="fm_work_para">
                            <img src="img/bestprice3.png" alt="" class="img-responsive bestpriceimg" width="40">
                            <p>Free Cancellation & Reschedule</p>
                            <div class="para_u">
                                <span class="fm_work_para_span_u mb-3">Book now, cancel or change anytime later</span>
                            </div>
                            <span class="fm_work_para_span">Book your slot today and change the date later anytime
                                FREE cancelation and full refunds with no questions asked
                                Book slots in advance to avoid high demand <span id="more3">and high
                                    prices</span></span>
                            <span onclick="myFunction3()" id="readmorebtn3">know more</span>
                        </div>
                    </div>
                    <div class="fm_work_content_best">
                        <div class="fm_work_para">
                            <img src="img/bestprice4.png" alt="" class="img-responsive bestpriceimg" width="40">
                            <p>Dedicated Move Manager</p>
                            <div class="para_u">
                                <span class="fm_work_para_span_u mb-3">Be tension free and let the move manager take
                                    care</span>
                            </div>
                            <span class="fm_work_para_span">Move manager to make your shifting hassle-free
                                Move manager makes sure no delays happen on the shifting day
                                Reminders about your movement, solving problems<span id="more4"> before they
                                    happen</span></span>
                            <span onclick="myFunction4()" id="readmorebtn4">know more</span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="carousel-inner testi-carousel-inn container-fluid">
                        <div class="carousel-item active">
                            <div class="row carouse-row">
                                <div class="col-lg-6 col-md-12 col-sm-12 p-4 mb-4">
                                    <div class="carouse-content">
                                        ...
                                        <p class="small-comment">Convenience guaranteed by FastDeliver packers and
                                            movers</p>
                                        <p class="small-content">I am extremely happy with my experience with NoBroker
                                            movers and packers team. Being a senior citizen while shift from Hyderabad
                                            to Ranchi I was worried about the entire shifting process. But thanks to
                                            Nobroker and their team for making the entire process smooth and easy</p>
                                        <p class="small-position">Head-Strategy & Business Development Jakson Ltd.</p>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-12 col-sm-12 p-4 mb-4">
                                    <div class="carouse-content">
                                        ...
                                        <p class="small-comment">Recommended for everyone looking for best-in-class
                                            services!</p>
                                        <p class="small-content">Extraordinary services and customer support provider by
                                            NoBroker Packers and Movers for my shifting from Faridabad to Lucknow.
                                            Extremely happy with the customer care and service provided by their team.
                            ...
                            <div class="row carouse-row">
                                <div class="col-lg-6 col-md-12 col-sm-12 p-4 mb-4">
                                    <div class="carouse-content">
                                        ...
                                        <p class="small-content">I'm very happy with the quality of services provided by
                                            Nobroker Packers and movers. A designated movement manager is assigned to
                                            each customer which makes the entire shifting process very convenient.</p>
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 p-4 mb-4">
                                    <div class="carouse-content">
                                        ...
                                        <p class="small-comment">Exceptional customer support & hassle free movement!
                                        </p>
                                        <p class="small-content">Professionalism with quality services is what you get
                                            with NoBroker Packers and Movers. Their entire team including their Movement
    ...
    function myFunction4() {
        ...
        var btnText = document.getElementById("readmorebtn4");
